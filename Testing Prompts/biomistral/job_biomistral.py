...
model_path = "/scratch/gent/490/vsc49096/BioMistral-7B"
...
for prompt_index, query_text in enumerate(query_texts, start=1):
    ...
    os.makedirs("ppi_outputs_biomistral", exist_ok=True)
    output_path = os.path.join("ppi_outputs_biomistral", output_file)
