...
query_texts = [
    """Consider each sentence separately and infer every pair of Protein-Protein Interactions from the provided sentence.
...
for prompt_index, query_text in enumerate(query_texts, start=1):
    ...
    os.makedirs("ppi_outputs_mistral4", exist_ok=True)
    output_path = os.path.join("ppi_outputs_mistral4", output_file)
